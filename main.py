...
title_text = Label(text="Timer", font=(FONT_NAME, 40, "bold"), bg=YELLOW, fg=GREEN)
title_text.grid(column=1, row=0)

start_button = Button(text="start", font=(FONT_NAME, 10, "bold"), fg=RED, highlightthickness=0, command=start_timer)
